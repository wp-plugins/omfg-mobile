var scnDialogHelper = {
    ...
    loadShortcodeDetails: function () {
        if (scnSelectedShortcodeType) {
            var a = this;
            jQuery.getScript(omfgPluginDir + "includes/template/groove-theme/shortcode-generator/sc/" + scnSelectedShortcodeType + ".js", function () {
                a.initializeDialog()
            })
        }
    },
    ...
    previewAction: function (a) {
        ...
        jQuery("#scn-preview-iframe").attr("src", omfgPluginDir + "includes/template/groove-theme/shortcode-generator/preview-shortcode-external.php?shortcode=" + encodeURIComponent(this.makeShortcode()))
    },
