(
    ...
    var icon_url = '../wp-content/plugins/omfg-mobile/shortcode-generator/tinymce/img/icon.png';

    tinymce.create(
    	"tinymce.plugins.OMFGShortcodeNinjaPlugin", 
    	{
        	...
        	init: function (d, e, url) {
            	...
            	d.onNodeChange.add(function (a, c) {
                	c.setDisabled("omfg_scn_button", a.selection.getContent().length > 0)
            	})
        	},
        	
        	createControl: function (d, e) {
            	
            	if (d == "omfg_scn_button") {
                	d = e.createMenuButton("omfg_scn_button", {
    	...
    	tinymce.PluginManager.add("OMFGShortcodeNinjaPlugin", tinymce.plugins.OMFGShortcodeNinjaPlugin)
	}
)();